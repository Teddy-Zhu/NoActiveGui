...
public class CornerLabelView extends View {
    ...
    public CornerLabelView setFillColorWithColorFilter(@ColorInt int color) {
    ...
    public CornerLabelView setFillColorResourceRemoveColorFilter(@ColorRes int resource) {
